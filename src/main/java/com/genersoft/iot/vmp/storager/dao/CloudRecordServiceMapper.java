...
public interface CloudRecordServiceMapper {
        ...
        @Select(" <script>" +
                        ...
                        " </script>")
        CloudRecordItem getListByFileName(@Param("app") String app, @Param("stream") String stream,
        ...
        @Update(" <script>" +
                        "update wvp_cloud_record set upload_status = #{uploadStatus}, oss_url = #{ossUrl} " +
                        " where app=#{app} and stream=#{stream} and file_name = #{fileName} " +
                        " </script>")
        int updateOssInfo(@Param("app") String app, @Param("stream") String stream, @Param("fileName") String fileName,
                        @Param("uploadStatus") Integer uploadStatus, @Param("ossUrl") String ossUrl);
}
